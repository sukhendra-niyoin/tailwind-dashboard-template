            ...
            <main className="grow">
                <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                    <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
                        <div className="mb-3">
                            <h2 className="text-2xl font-bold text-blue-600 dark:text-white">Fund Receive History</h2>
                        </div>
                        <div className="mb-6">
                            <form className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                                ...
                                <div className="flex items-end">
                                    <button 
                                        type="submit" 
                                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-1 px-4 rounded-lg  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-gray-700 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white transition-all duration-300 ease-in-out"
                                    >
                                        Search
                                    </button>
                                </div>
